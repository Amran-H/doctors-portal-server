...
function sendBookingEmail(booking) {
    ...
    transporter.sendMail({
        from: "amran.h.akash@gmail.com", // verified sender email
...
<p>Please vist us on ${appointmentDate} at ${slot} </p>
<p>Thank from doctor portals</p>
</div>
...
async function run() {
    try {
        ...
        */
        ...
        //  temporary to update price field on apponintment options
